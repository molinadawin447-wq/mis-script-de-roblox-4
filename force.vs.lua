...
local function setupChar(char)
    ...
    if head then
        local old = head:FindFirstChild("ForceBB"); if old then old:Destroy() end
        local bb = Instance.new("BillboardGui", head)
        bb.Name="ForceBB"; bb.Size=UDim2.new(0,130,0,36)
...
print("[Force Hub] Cargado - Letras con sombra chorreada aplicadas.")